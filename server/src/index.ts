...
import { Scale, FacebookReel, DownloadReelRequest } from '@guitar-app/shared';
...
const checkFacebookAuth = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
...
// GET /api/reels
app.get('/api/reels', checkFacebookAuth, async (req, res) => {
  try {
