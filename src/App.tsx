...
import { Box, Container, CssBaseline, ThemeProvider, IconButton } from '@mui/material';
                      ...
                      {(provided, snapshot) => (
                        <Box
                          ...
                          sx={{
                            ...
                            borderRadius: 2,
                            boxShadow: snapshot.isDragging ? theme.shadows[12] : theme.shadows[1],
